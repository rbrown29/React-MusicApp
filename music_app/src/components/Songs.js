    ...
    render() {
        return (
            <tr className='songrows'>
              ...
              <td className='coverart'><img className='covers' onClick={()=>{this.props.addToFavorites(this.props.songs)}} src={this.props.songs.coverArt}/><p className='add' onClick={()=>{this.props.addToFavorites(this.props.songs)}}>Add to Favorites</p>
